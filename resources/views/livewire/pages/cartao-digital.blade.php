<div class="bg-primary grow">
    <x-ui::container>
        <x-ui::swiper data-id="{{ $colaborador?->id }}" options="{ initialSlide: {{ Js::from($colaborador?->id - 1) }}, slidesPerView: 1.2, spaceBetween: 40, centeredSlides: true, breakpoints: { 800: {slidesPerView: 4.12 } } }">
